...
const PATHS: Record<string, React.ReactNode> = {
  ...
  cam: <path d="M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2zM12 17a4 4 0 100-8 4 4 0 000 8z" />,
  ...
  block: <path d="M12 21a9 9 0 100-18 9 9 0 000 18zM4.93 4.93l14.14 14.14" />,
...
export default function Icon({ name, size = 14, color, strokeWidth = 1.6 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
